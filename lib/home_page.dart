...
import 'package:walletapp/contact_page.dart';
import 'package:walletapp/send_money_page.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Color.fromARGB(0, 219, 219, 219),
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    MaterialButton(
                      ...
                      shape: RoundedRectangleBorder(
                          side: BorderSide(
                              color: Color.fromARGB(255, 70, 41, 255).withOpacity(0.4),
                              width: 1),
                          borderRadius: BorderRadius.circular(10)),
                      splashColor: Color.fromARGB(255, 46, 115, 255).withOpacity(0.4),
                      highlightColor: const Color.fromARGB(255, 70, 41, 255).withOpacity(0.4),
                      padding: const EdgeInsets.symmetric(
                          horizontal: 30, vertical: 15),
