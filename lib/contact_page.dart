            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  filled: true,
                  fillColor: Color.fromARGB(255, 144, 143, 143),
          ...
          child: Column(
              ...
              children: <Widget>[
                ...
                FadeInUp(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: Color.fromARGB(255, 6, 6, 6), width: 1.0),
                    ),
                    child: Stack(
                      children: [
                ...
                FadeInRight(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.only(left: 20.0, bottom: 15.0, top: 10.0),
                    child: Text('All Contacts', style: TextStyle(fontSize: 16, color: Color.fromARGB(255, 0, 0, 0), fontWeight: FontWeight.w500),),
                  ),
                ),
                Container(
